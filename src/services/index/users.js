...
export const signup = async ({ name, email, password, birth, interest }) => {
  try {
    ...
    // Opsional: Logging error ke console
    console.error("Signup error:", error);

    // Lempar ulang error asli dari axios, JANGAN bikin error baru
    throw error;
  }
};

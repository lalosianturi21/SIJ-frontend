    ...
    >
      ...
      <div className="flex-1 flex flex-col w-full">
        ...
        <div className="flex flex-wrap items-center gap-2 sm:gap-3 text-dark-light font-roboto text-sm mt-3 mb-3">
          {isUserLoggined && (
            <button
              className="flex items-center space-x-1 sm:space-x-2 text-black hover:text-gray-500 transition"
              onClick={() =>
          ...
          {commentBelongsToUser && (
           ...
           <button
  className="flex items-center gap-2 px-4 py-2 rounded-xl bg-red-500 text-white hover:bg-red-600 hover:shadow-md transition-all duration-200 ease-in-out"

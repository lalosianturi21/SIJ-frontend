...
const CountryPage = () => {
  ...
  const { data, isLoading, isError, refetch } = useQuery({
    queryFn: () => getAllCountries(searchKeyword, currentPage, 12),
    queryKey: ["countries"],
    onError: (error) => {
      ...
      <div className="w-full p-3">
        <div className="mx-auto items-center justify-center max-w-7xl flex mt-[120px]">
          <div className="pb-4 lg:text-l w-full justify-between text-m">
            ...
            <span className="cursor-pointer font-semibold">Negara</span>
          </div>
        </div>
              ...
              <table className="w-full">
                ...
                <tbody className="text-s font-medium">
                  {isLoading ? (
                    ...
                    <ErrorMessage message="Couldn't fetch the countries data" />
                  ) : data?.data.length === 0 ? (
                    <tr>

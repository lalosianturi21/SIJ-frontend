...
const InstitutionPage = () => {
  ...
  const { data, isLoading, isError, refetch } = useQuery({
    queryFn: () => getAllInstitutions(searchKeyword, currentPage, 12),
      ...
      <div className="w-full p-3">
        <div className="mx-auto items-center justify-center max-w-7xl flex mt-[120px]">
          <div className="pb-4 lg:text-l w-full justify-between text-m">
            ...
            <span className="cursor-pointer font-semibold">Perguruan Tinggi</span>
          </div>
        </div>
              ...
              <table className="w-full">
                ...
                <tbody className="text-s font-medium">
                  {isLoading ? (
                    ...
                    <ErrorMessage message="Couldn't fetch the institutions data" />
                  ) : data?.data.length === 0 ? (
                    <tr>
